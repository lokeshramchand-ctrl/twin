...
**API Documentation** 
(Specifically utilizing synthetic markdown files containing technical specs, API endpoints, and rate limits that undergo explicit, breaking changes from Version 1 to Version 2).
